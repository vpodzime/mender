...
class MenderContext {
public:
	error::Error Setup(const conf::MenderConfig &config);
	kv_db::KeyValueDatabase &GetMenderStoreDB { return mender_store_ };
private:
#if MENDER_USE_LMDB
	kv_db::KeyValueDatabaseLmdb mender_store_;
#else
	kv_db::KeyValueDatabaseInMemory mender_store_;
