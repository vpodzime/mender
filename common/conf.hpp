...
public:
	CmdlineOptionsIterator(const vector<string> &args, const OptsSet &opts_with_value, const OptsSet &opts_without_value) :
			args_(args), opts_with_value_(opts_with_value), opts_wo_value_(opts_without_value) {};
